...
T = 1/Fs; % Sample time
L = 1000; % Length of signal ; s? m?u s? d?ng ?? v? tín hi?u
t = (0:L-1)*T; % Time vector
x = 0.7*sin(2*pi*50*t) + sin(2*pi*120*t); %Tín hi?u ??u vào, là t?ng c?a 2 sin
y = x + 2*randn(size(t)); % Tín hi?u có thêm nhi?u
figure;
